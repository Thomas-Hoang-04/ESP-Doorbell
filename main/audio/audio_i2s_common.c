...
esp_err_t audio_i2s_common_init(void)
{
    ...
    s_i2s_ctx.initialized = true;
    ESP_LOGI(AUDIO_I2S_TAG, "I2S initialized: %d Hz, %d ch, %d bit", 
             AUDIO_I2S_SAMPLE_RATE, AUDIO_I2S_CHANNELS, AUDIO_I2S_BITS_PER_SAMPLE);
